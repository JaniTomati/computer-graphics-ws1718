...
void main(void) {
	...
	// vertex_Position_View = (ViewMatrix * vec4(vertex_Position, 0.0)).xyz;

	vertex_Position_Cam = ((ViewMatrix * ModelMatrix * NormalMatrix) * vec4(in_Position, 1.0)).xyz;

	light_Position = (ViewMatrix * vec4(0.0, 0.0, 0.0, 1.0)).xyz;
